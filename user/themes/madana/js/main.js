$(function(){
    ...
    $(".colorr").click(function (e) { 
        ...
        $("#prevc").css("background", "rgba("+ rpil +","+ gpil +","+ bpil +",255)");
    });
    ...
    */
    ...
    function showhasil(URI){
        ...
        var close = $("<a >").attr("href","#").text("X").addClass("btn btn-default");
    ...
    //Untuk Rotate Keramik sesuai keinginan
    $("#bRotasi").click(function (e) {  
        ...
        rctx.drawImage(canvas,-canvas.width/2,-canvas.width/2);
        rctx.restore();
        cCo.clearRect(0,0,230,230);
        cCo.drawImage(rotate,0,0,230,230);
    });
    ...
    $("#r9").click(function (e) {
        ...
        $(".dvt").click(function(){
            $("#virtualfloor").find(".floor").attr("src","");
        });
    });

    //Zoom In For Image 
    $(".btn-zoom").click(function() {
        //Get the bapaknya, mamaknya, terus turun kebawah cari 
        var parent = $(this).parent();
        var dapatkan = parent.find(".zoomi");
        var lokasi = dapatkan.attr("src");
        var text = parent.find(".pattern-text").text();
        $("#zoomshow").find(".zoomi").attr("src",lokasi);
        $("#zoomshow").find(".pattern-text").text(text);
        $("#zoomshow").show("slow");
