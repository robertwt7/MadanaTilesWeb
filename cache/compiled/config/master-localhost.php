...
return [
    ...
    'timestamp' => 1467301515,
    'checksum' => '4f67ddf42b5b953214888fbb0888c363',
    'files' => [
        'user/config' => [
            'media' => [
            ...
            'themes/mandana' => [
                'file' => 'user/config/themes/mandana.yaml',
                'modified' => 1463730733
            ]
        ],
        'system/config' => [
    ...
    'data' => [
        ...
        'site' => [
            ...
            'metadata' => [
                'description' => 'Moji on craft tile website is a great one'
            ],
            'summary' => [
                'enabled' => true,
                'format' => 'short',
