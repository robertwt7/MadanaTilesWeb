...
class __TwigTemplate_238e1ae95f8ed46af7157da4cc4a3e019749b264bb57b84338b0a46f6bbfcecb extends Twig_Template
{
...
";
    ...
    {
        // line 7
        echo "    <div class=\"form-field form-group ";
...
/* */
/* {% block field %}*/
/*     <div class="form-field form-group {% if vertical %} vertical{% endif %}{% if field.outerclasses is defined %} {{ field.outerclasses }}{% endif %}">*/
/*         {% block contents %}*/
